...
ALREADY_APPLIED = (
    'import { getSaddleSectionMetrics } from "./quote-book/saddle-calculator.js";' in text
    and "const isSaddleBinding = selectedBindingType === 'saddle';" in text
)

if ALREADY_APPLIED:
    print('saddle refactor already applied; no changes')
    raise SystemExit(0)
...
replace_once(
    'use saddle metrics for inner pricing',
...
replace_once(
    'store and display saddle pricing unit',
...
print('saddle refactor applied successfully')
