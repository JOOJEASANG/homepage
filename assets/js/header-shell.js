...
(function () {
  ...
  function render() {
    ...
    mount.innerHTML = `
      <header class="fixed w-full top-0 z-50 bg-white border-b border-slate-200 shadow-sm h-16" id="main-header" data-header-shell="fallback">
        <nav class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center justify-between">
          ...
          <div class="flex items-center gap-1">
            <button id="btn-mobile-menu-shell" type="button" class="lg:hidden p-2 text-slate-600 hover:text-brand-600 transition" aria-label="메뉴 열기">
